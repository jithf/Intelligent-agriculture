...
import jit.hf.agriculture.util.RandomUtils;
...
public class OrderInfoServiceImpl implements OrderInfoService {
    ...
    public boolean validOrder(Map<String,String> params) throws Exception {
        ...
        */
        ...
        OrderInfo orderInfo = orderInfoRepository.findOneByOrderId( orderId );
        if(orderInfo == null) {
            return false;
        }
        // 2、判断金额是否相等
    ...
    public OrderInfo getByIdOrAlipayNo(String orderId, String alipayNo) {
        ...
        if(StringUtils.isNotBlank(alipayNo)) {
            ...
            List<OrderInfo> list = orderInfoRepository.findAllByAlipayNo( alipayNo );
